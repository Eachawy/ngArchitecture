...
template: `
       <div class="ui-inputgroup ui-float-label {{styleClass}}" [ngClass]="{'invalid-input' : validationControl.invalid && validationControl.touched}">
...
// \\ ================================
    ...
    //     [styleClass]="'internal'"                              ------------add internal class
